...
mkdir(strcat('G:\My Drive\RE_maps_tau\check_cell_types\',mouse,'\'));
        ...
        for pathdata = list_sessions_cut_log %string('020924')
            ...
            for cell_i = clusters(new_cell_types==celltype_target)'
                    ...
                    if iplot > 25
                        ...
                        print(strcat('G:\My Drive\RE_maps_tau\check_cell_types\',mouse,'\',celltype_target,'_',num2str(ipdf)),'-dpdf');
                        ipdf=ipdf+1;
                        iplot=1;
                        close all;
                        figure;
