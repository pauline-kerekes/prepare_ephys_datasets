...
% Bin %
%% PK change the binwidth: it will be 10ms for 500ms windows and 1ms otherwise 
if maxInt==500 
    binwidth = 25; % was maxInt/opt.divisions, PK changed it on 070325 to have bins of 10ms.
elseif maxInt==100
    binwidth = 2;
else
    binwidth = 1; %1; % was maxInt/opt.divisions, PK changed it on 070325 to have bins of 1ms.
end
%%
